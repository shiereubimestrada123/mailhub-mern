...
export function Modal({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="fixed bottom-0 right-0 mb-[-16px] mr-[-16px] flex flex-col items-end">
      <div className="modal-box md:w-[600px] md:h-[500px] w-[400px] h-[250px] p-0 rounded-none">
